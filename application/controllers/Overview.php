...
class Overview extends CI_Controller{
    ...
    function index(){
        ...
        $this->load->model('forum_kejadian_model');
        $data['kejadianskcount'] = $this->daftar_kejadian_model->count_all();
        $data['kejadianswcount'] = $this->kejadian_siswa_model->count_all();
        $data['interaksiortucount'] = $this->forum_kejadian_model->count_all();
        $data['datahighchart'] = $this->kejadian_siswa_model->datahighchart();
    ...
    $data['chart'] = $chart;
    $this->load->view('admin/ovw2',$data);
