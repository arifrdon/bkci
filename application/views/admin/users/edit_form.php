						...
						<form action="<?php base_url('admin/users/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('user_name') ? 'is-invalid':'' ?>"
								 type="text" name="user_name" placeholder="Username" value="<?php echo $user->user_name ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('user_password') ? 'is-invalid':'' ?>"
								 type="text" name="user_password"  placeholder="User Password" value="<?php echo $user->user_password ?>" />
								<div class="invalid-feedback">
